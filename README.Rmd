...
Quack is a separate DuckDB extension. Install it explicitly for the DuckDB
runtime used by R before running server/client examples. In this checkout,
`make quack` performs that installation.
